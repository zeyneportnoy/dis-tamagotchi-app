export const tr = {
  translation: {
    ...
    brushing: {
      ...
      offSlotNotice: {
        title: 'Harika fırçaladın! 🦷',
        body: 'Bu fırçalama puan saatlerinin dışında olduğu için bu kez puan eklenmedi.',
        hoursTitle: '20 puan kazanabileceğin saatler:',
        morningLabel: '🌞 Sabah:',
        morningHours: '04.00–11.59',
        eveningLabel: '🌙 Akşam:',
        eveningHours: '18.00–23.59',
        confirm: 'Tamam',
      },
    ...
    parent: {
      ...
      reminders: {
        ...
        timeHint: 'Saat ve dakikayı istediğiniz zaman için seçebilirsiniz.',
        chooseTime: '{{slot}} saatini seç. Mevcut saat {{time}}.',
