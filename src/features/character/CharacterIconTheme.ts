...
const iconSources: Record<CharacterIconThemeSet, Record<CharacterIconName, ImageSourcePropType>> = {
  set1: {
    ...
    background: require('../../../assets/icons/character-themes/set1/category-background-v2.png'),
    room: require('../../../assets/icons/character-themes/set1/category-room-v2.png'),
    effect: require('../../../assets/icons/character-themes/set1/category-effect-v2.png'),
    accessory: require('../../../assets/icons/character-themes/set1/accessory.png'),
    brush: require('../../../assets/icons/character-themes/set1/category-brush-v2.png'),
